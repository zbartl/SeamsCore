        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EditRole = table.Column<string>(nullable: true),
                    IsInNavigation = table.Column<bool>(nullable: false),
                    IsUserCreated = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Page_PageTemplate_TemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    PageColumn = table.Column<int>(nullable: false),
                    PageId = table.Column<int>(nullable: false),
                    SeaId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PageSlot", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PageSlot_Page_PageId",
                        column: x => x.PageId,
                        principalTable: "Page",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PageSlotHtml", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PageSlotHtml_PageSlot_SlotId",
                        column: x => x.SlotId,
                        principalTable: "PageSlot",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PageSlot_PageId",
                table: "PageSlot",
                column: "PageId");

            migrationBuilder.CreateIndex(
                name: "IX_PageSlotHtml_SlotId",
                table: "PageSlotHtml",
                column: "SlotId");
